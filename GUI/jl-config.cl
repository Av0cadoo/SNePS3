...
;; $Id: jl-config.cl,v 1.1 2010/05/18 02:28:48 mwk3 Exp $
...
(setf javatools.jlinker:*jlinker-java-home* nil)        
(setf javatools.jlinker:*jni-library* "C:\\Program Files\\Java\\jre7\\bin\\server\\jvm.dll")
